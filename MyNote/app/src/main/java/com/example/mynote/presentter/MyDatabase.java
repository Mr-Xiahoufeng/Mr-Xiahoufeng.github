package com.example.mynote.presentter;
...
public class MyDatabase {
    ...
    public ArrayList<Data> getarray(){            //获取listview中要显示的数据
        ...
        while(!cursor.isAfterLast()){
            @SuppressLint("Range") int id = cursor.getInt(cursor.getColumnIndex("ids"));
            @SuppressLint("Range") String title = cursor.getString(cursor.getColumnIndex("title"));
            @SuppressLint("Range") String times = cursor.getString(cursor.getColumnIndex("times"));
